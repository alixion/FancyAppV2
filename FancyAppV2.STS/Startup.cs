...
using FancyAppV2.STS.Data;
using FancyAppV2.STS.Resources;
using FancyAppV2.STS.Services;
using FancyAppV2.STS.Filters;
using FancyAppV2.STS.Services.Certificate;
using Serilog;
...
namespace FancyAppV2.STS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllersWithViews(options => { options.Filters.Add(new SecurityHeadersAttribute()); })
                .AddViewLocalization()
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseCsp(opts => opts
                ...
                .FrameAncestors(s => s.CustomSources(
                    "https://localhost:44359", "https://localhost:6101")
                )
            ...
            GetCertificates(IWebHostEnvironment environment, IConfiguration configuration)
        {
            ...
            (X509Certificate2 ActiveCertificate, X509Certificate2 SecondaryCertificate) certs = await CertificateService
                .GetCertificates(
