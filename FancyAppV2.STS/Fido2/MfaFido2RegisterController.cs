    ...
    public class MfaFido2RegisterController : Controller
    {
            ...
            [FromForm] string userVerification)
        {
            try
            {
                ...
                {
                    Extensions = true, UserVerificationIndex = true, Location = true, UserVerificationMethod = true,
        ...
        public async Task<JsonResult> MakeCredential([FromBody] AuthenticatorAttestationRawResponse attestationResponse)
        {
            try
            {
                ...
                if (user == null)
                {
                    ...
                    {
                        Status = "error",
                        ErrorMessage = _sharedLocalizer["FIDO2_USER_NOTFOUND", _userManager.GetUserId(User)]
                    });
                }
